...
void GcodeSuite::M190() {
  ...
  // lcd_setstatus_P(thermalManager.isHeatingBed() ? GET_TEXT(MSG_BED_HEATING) : GET_TEXT(MSG_BED_COOLING));

  lcd_setstatusPGM(thermalManager.isHeatingBed() ? MMSG_BED_HEATING[wtvar_language] : MMSG_BED_COOLING[wtvar_language]);
