...
#define MSG_SD_REMOVED                      "Tarjeta extraida"
...
#define MSG_AUTO_HOME                       "Auto Inicio"
...
#define MSG_HEATING                         "En calentamiento"
...
#define MSG_OFFSET_Z						"Desfase Z"				// 设置Z偏移
#define MSG_SET_BEEP						"Beep"					// 设置Beep

#define MSG_MACHINE_INFO					"informacion"			// 设备信息
#if LCD_WIDTH > 19
...
#define MSG_INFO_MACHINE					"dispositivo"						// 设备
#define MSG_INFO_VERSION					"version"						// 版本
#define MSG_WIFI_CANCELPRINTING				"detener la impresion wifi"			// 停止Wifi打印
#define MSG_FILAMENTIN                      "entrada de filamento"				// 载入料丝
#define MSG_FILAMENTOUT                     "salida de filamento"				// 卸载料丝
#define MSG_ZPROBE_TITLE                   "Desfase Z (mm)"				// 设置Z偏移
#define	MSG_FILAMENT_CHANGE_HEADER_LOAD		MSG_FILAMENTIN
#define MSG_FILAMENT_CHANGE_HEADER_UNLOAD	MSG_FILAMENTOUT
...
#define MSG_FILAMENT_CHANGE_OPTION_PURGE    "carga mas"		// 载入更多料丝
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Resumir imp.")
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Injector: ")
#define MSG_ERR_HOMING_FAILED               "homing fallo"			// 回原点失败
#define MSG_ERR_PROBING_FAILED              "el sondeo fallo"		// 自动调平失败
...
#define MSG_FILAMENT_CHANGE_PURGE_2         "esperando carga"				// 等待载入
...
#define MSG_WELCOME_CONINUE					"continuar"
#define MSG_WELCOME_SKIP					"dejar"

#define MSG_WELCOME_SCREEN_1				"Bienvenido a"
#define MSG_WELCOME_SCREEN_2				"1 entrada de filamento"		// 第1步 载入料丝
#define MSG_WELCOME_SCREEN_3				"2 insertar tarjeta sd"			// 第2步 插入SD卡
#define MSG_WELCOME_SCREEN_4				"3 archivo de impresion"	// 第3步 打印SD卡文件
#define MSG_WELCOME_MENU					"Wizzard"						// 向导界面

#define MSG_PRINT_PAUSED                    "pausar impresion"					// 打印暂停
#define MSG_PRINTING                        "impresion"						// 打印

#define MSG_NETWORK_MENU					"red Wifi"						// 网络设置
#define MSG_NETWORK_IP						"mostrar direccion ip"			// 显示网络IP地址
#define MSG_NETWORK_INFO					"dispositivo wifi"			// 显示Wifi设备信息
#define MSG_NETWORK_CONFIG					"conectarse a wifi"			// 设置wifi网络
#define MSG_NETWORK_OTA						"dispositivo wifi ota"						// Wifi设备OTA
#define MSG_NETWORK_CONFIG_1				"abre la aplicacion"		// 打开APP进入WIFI设置
#define MSG_NETWORK_CONFIG_2				"en configuracion wifi"			// 输入WIFI网络密码
#define MSG_NETWORK_CONFIG_3				"contrasena de entrada"				// 不要使用5G Wifi
#define MSG_NETWORK_CONFIG_4				"no usar 5g wifi"
#define MSG_NETWORK_OTA_1					"no cierres el poder"				// 不要关闭电源 
#define MSG_NETWORK_OTA_2					"espera un minuto"

#define MSG_UPLOADING_1						"Descargando:"						// 正在下载
